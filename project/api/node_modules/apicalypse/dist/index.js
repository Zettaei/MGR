...
class Apicalypse extends _builder.default {
  ...
  cleanLimitOffset() {
    ...
    const limit = parseInt(this.queryFields.limit && this.queryFields.limit.split(" ")[1]) || 50;
    const offset = parseInt(this.queryFields.offset && this.queryFields.offset.split(" ")[1]) || 0;
