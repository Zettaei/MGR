...
function UserRecordListModal({ keepList, platformStoreList, game }) {
    ...
    return (
        <>
                ...
                <div className="mb-1">
                    <div className="pt-1 pb-3 px-4">
                        ...
                        <div className="row mb-1">
                            ...
                            <div className="col-3">
                                <button className="mb-2 btn btn-warning w-100 mt-4"
                        ...
                        <div className="card" >
                            <div className="card-header mb-0" style={"font-size: 1rem;"}>
                                <div className="d-flex justify-content-between align-items-center">
                                    Records:
                                    <button className="btn btn-warning" data-bs-toggle="modal" data-bs-target="#AddRecordModal">
            ...
            <AddRecordModal keepList={keepList} platformStoreList={platformStoreList} />
            <EditGameModal keepList={keepList} game={game} />
            <EditRecordModal keepList={keepList} platformStoreList={platformStoreList} record={{ selectedRecord, setSelectedRecord }} />
        </>
    )
}
